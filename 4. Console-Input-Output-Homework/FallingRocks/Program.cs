...
namespace FallingRocks
{
    class FallingRocks
    {
        ...
        private static Position dwarfCurrentPosition = new Position();
        ...
        static void Main()
        {
            ...
            dwarfCurrentPosition.X = Console.WindowWidth / 2 - 1;
            dwarfCurrentPosition.Y = Console.WindowHeight - 1;
            PrintInfoScreen();
            PrintDwarf(dwarfCurrentPosition);
            while (gameOn)
            {
        ...
        static void PrintInfoScreen()
        {
            string info =
@"RULES OF THE GAME 
You can move the dwarf left and right with the keyboard
...
Press any key to start the game!";
        ...
        {
            if ((dwarfCurrentPosition.X == Console.WindowWidth - statusBarWidth - 3 && currentDirection == 2) || (dwarfCurrentPosition.X == 0 && currentDirection == 1))
            {
                currentDirection = 0;
            }
            dwarfCurrentPosition.X += (moveDirections[currentDirection]).X;
            PrintDwarf(dwarfCurrentPosition);
        }
        //Stones stuff
